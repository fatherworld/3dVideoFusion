...
//		rotates +=  deltaTime * speed;
//
//		cout << "Move froward rotates is " << rotates << endl;
//
//	}
//	// Move backward
...
//		rotates -= deltaTime * speed;
//
//		cout << "Move backward rotates is " << rotates << endl;
//	}
//	// Strafe right
...
//
//	ModelMatrix = glm::rotate(model, rotates * glm::radians(50.0f), glm::vec3(0.5f, 1.0f, 0.0f));
